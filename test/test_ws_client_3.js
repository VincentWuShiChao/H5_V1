...
sock.on("open", function () {
    ...
    sock.send('{"tag":2,"name":"xiaoquan","token":""}');
});
...
sock.on("message", function(data) {
    ...
    if(json_value.msg=="linkSuccess"){
        sock.send('{"tag":0,"name":"xiaoquan","token":"","integral":1700,"type":1}');
        ...
        if(json_value.data.state==0){
            ...
            console.log("匹配完成");
            sock.send('{"tag":4,"name":"xiaoquan","token":"","integral":1700,"type":1,"result_score":200}');
        }
    }
});